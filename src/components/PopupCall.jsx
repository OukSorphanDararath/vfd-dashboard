...
const PopupCall = ({ onCancel, onPickUpCall }) => {
  return (
    <div
...
rounded-3xl absolute right-6 top-20 z-50"
    >
      ...
      <div className="self-end flex gap-2">
        <button
          className="p-2 bg-red-600 rounded-full w-14 h-10 flex justify-center items-center shadow-md hover:bg-red-700"
          onClick={onCancel}
        >
          <FaTimes />
        </button>
        <button
          className="p-2 bg-green-600 rounded-full w-14 h-10 flex justify-center items-center shadow-md hover:bg-green-700"
          onClick={onPickUpCall}
        >
          <FaCamera />
        </button>
      </div>
